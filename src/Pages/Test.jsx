...
function createData(name,  cloud,calories, fat, carbs, protein) {
    return { name,cloud,calories, fat, carbs, protein };

}

const rows = [
    createData('Frozen yoghurt','GCP',159, 6.0, 24, 4.0),
    createData('Ice cream sandwich','GCP', 237, 9.0, 37, 4.3),
    createData('Eclair','GCP', 262, 16.0, 24, 6.0),
    createData('Cupcake','GCP', 305, 3.7, 67, 4.3),
    createData('Gingerbread','GCP', 356, 16.0, 49, 3.9),
];
                            ...
                            {rows.map((row) => (
                                ...
                                >
                                    <TableCell component="th" scope="row" style={{ textAlign: "start", borderBottom: "1px solid lightgrey" }}>
                                        <QuizOutlinedIcon style={{ marginRight: 8, opacity: 0.3 }} />
                                        {row.name}
                                    </TableCell>
                                    <TableCell align="right" style={{ textAlign: "start", borderBottom: "1px solid lightgrey" }}>{row.cloud}
                                    </TableCell>
