              ...
              <TableBody>
                {getData && getData.length > 0 ? (
                  getData.map((row) => (
                    ...
                    >
                      <TableCell>{row.cloudProvider}</TableCell>
                      <TableCell>{row.cloudAccountId}</TableCell>
                      <TableCell>{row.scanStatus}</TableCell>
                      <TableCell>{row.scanComplianceStatus}</TableCell>
                      <TableCell>{row.scanCreatedOn}</TableCell>
                    </TableRow>
                  ))
                ) : (
                  <TableRow>
