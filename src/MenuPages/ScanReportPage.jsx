...
function ScanReportPage() {
  ...
  function fetchData() {
    ...
    fetch(
      `http://localhost:8000/v1/collection/scanresultdata?page=${currentPage}&limit=100`,
      requestOptions1
    )
      .then((response1) => response1.text())
      .then((result1) => {
        const parsedResult1 = JSON.parse(result1);
        console.log("result1", parsedResult1);
          ...
          {loading ? (
            ...
            <table>
              <thead>
                ...
                >
                  <th className="text-center">Scan Type</th>
              ...
              <TableBody>
                ...
                {getData?.map((row) => (
                  ...
                  >
                    ...
                    <TableCell>{row.testTitle}</TableCell>
                    <TableCell>{row.testDescription}</TableCell>
                    <TableCell>{row.cloudAssetCategory}</TableCell>
                    <TableCell>{row.cloudAssetRegion}</TableCell>
                    <TableCell>{row.cloudAssetId}</TableCell>
                    <TableCell>{row.testStatus}</TableCell>
                    <TableCell>{row.testOutput}</TableCell>
