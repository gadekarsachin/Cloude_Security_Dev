...
export default function Scan() {
  ...
  const handleLimitChange = (newLimit) => {
    ...
    fetchData(newLimit); // Call your fetchData function with the new limit
  };
  ...
  const dataToSend =
    { id: "64f855bd07e7a348bcbfc11c", menuname: "scandata" } || {};
        ...
        <div className="card-header d-flex justify-content-between">
          ...
          <div className="limitcont border px-2 py-1 rounded">
            ...
            <div className="plimits">
              <div onClick={() => handleLimitChange(10)}>10</div>
              <div onClick={() => handleLimitChange(25)}>25</div>
              <div onClick={() => handleLimitChange(50)}>50</div>
              <div onClick={() => handleLimitChange(100)}>100</div>
            </div>
          </div>
        </div>
              ...
              <table>
                  ...
                  <tr>
                    {gethead.length > 0 ? (
                      <>
                        ...
                        <th className="text-center">Scan Compliance Status</th>
                        <th className="text-center">Scan Created On</th>
                ...
                <tbody>
                  ...
                  {getData && getData.length > 0 ? (
                    getData.map((row) => (
                      <tr key={row._id} style={{ overflow: "auto" }}>
                        <td>{row.scanId}</td>
                        <td>{row.cloudProvider}</td>
                        <td>{row.cloudAccountId}</td>
                        <td>{row.scanStatus}</td>
                        <td>{row.scanComplianceStatus}</td>
                        <td>{row.scanCreatedOn}</td>
                        <td>
                          <abbr title="Report">
                            <GrScan
                              style={{
