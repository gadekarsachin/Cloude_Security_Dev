...
import EditPolicy from "../components/modal/edit/EditPolicy";
import {
  RiDeleteBin6Line,
  RiAddBoxFill,
  RiAddFill,
...
import AddPolicy from "../components/modal/add/AddPolicy";
...
export default function PolicyManagement() {
  ...
  const dataToSend =
    { id: "652e7f9cd3daed2b388167a2", menuname: "PolicyManagementData" } || {};
  const pathSubMenu = "/policyManagement";
  ...
  function fetchData(token) {
    ...
    fetch(
      `http://localhost:8000/v1/collection/documentdata?page=${currentPage}&limit=${limit}`,
      requestOptions1
    )
      ...
      .then((result1) => {
        ...
        console.log("result1 hrushi documentdata_1", parsedResult1.data);
            ...
            >
              {loading ? (
                ...
                <table className="align-middle text-truncate mb-0 table table-borderless table-hover ">
                  ...
                  <TableBody>
                    {/* {console.log("getData.map", getData)} */}
                    {getData && getData.length > 0 ? (
                      getData.map((row) => (
                        ...
                        >
                          <TableCell>{row.docTitle}</TableCell>
