...
export default function UserManagement() {
  ...
  const dataToSend =
    { id: "64f84e0c07e7a348bcbfc0d8", menuname: "userdata" } || {};
  const pathSubMenu = "/userManagement";
                ...
                >
                  {gethead.length > 0 ? (
                    <>
                      ...
                      <th className="text-center">Last Login On</th>
                      <th className="text-center">Login IP Address</th>
                      <th className="text-center">Login Location</th>
                      <th className="text-center">Is Logged In</th>
                ...
                {getData && getData.length > 0 ? (
                  getData.map((row) => (
                    ...
                    >
                      ...
                      <TableCell>{row.userScope}</TableCell>
                      <TableCell>{row.userStatus}</TableCell>
                      {/* <TableCell>{row.failedLoginAttempts}</TableCell> */}
                      <TableCell>{row.userLoginTimestamp}</TableCell>
                      {/* <TableCell>{row.userAccessToken}</TableCell> */}
                      {/* <TableCell>{row.userRefreshToken}</TableCell> */}
                      <TableCell>{row.userLoginIPAddress}</TableCell>
                      <TableCell>{row.userLoginLocation}</TableCell>
                      {/* <TableCell>{row.userPreviousLoginLocation}</TableCell> */}
                      <TableCell>{row.loggedIn}</TableCell>
