...
export default function ClientManagement() {
  ...
  const pathSubMenu = "/clientManagement";
  ...
  function fetchData() {
    ...
    fetch(
      `http://localhost:8000/v1/collection/${dataToSend.menuname}?page=${currentPage}&limit=100`,
      requestOptions1
    )
      ...
      <div className="main-card mb-3 card">
        <div className="card-header">
          ...
          <div className="btn-actions-pane-right">
            <button
              className="btn btn-outline-primary d-flex justify-content-center align-items-sm-center text-none"
              onClick={() => {
                navigate("/submenuCreate", {
                  state: {
                    fieldsArray: fieldsArray,
                ...
                {getData && getData.length > 0 ? (
                  getData.map((row) => (
                    ...
                    >
                      ...
                      <TableCell>{row.clientLegalName}</TableCell>
                      <TableCell>{row.clientShortName}</TableCell>
                      <TableCell>{row.clientPrimaryContactFirstName}</TableCell>
                      <TableCell>
                        {row.clientPrimaryContactMiddleName}
                      </TableCell>
                      <TableCell>{row.clientPrimaryContactLastName}</TableCell>
                      <TableCell>
                        {row.clientSecondaryContactFirstName}
                      </TableCell>
                      <TableCell>{row.clientSecondContactMiddleName}</TableCell>
                      <TableCell>{row.clientSecondContactLastName}</TableCell>
                      <TableCell>{row.clientPrimaryContactEmail}</TableCell>
                      <TableCell>{row.clientSecondaryContactEmail}</TableCell>
                      <TableCell>
                        {row.clientPrimaryContactPhoneNumber}
                      </TableCell>
                      <TableCell>
                        {row.clientSecondaryContactPhoneNumber}
                      </TableCell>
                      <TableCell>
                        {row.clientPrimaryContactMobileNumber}
                      </TableCell>
                      <TableCell>
                        {row.clientSecondaryContactMobileNumber}
                      </TableCell>
                      <TableCell>{row.clientRegisteredAddress}</TableCell>
                      <TableCell>{row.clientOnboardingTimestamp}</TableCell>
                      <TableCell>{row.clientExpiryTimestamp}</TableCell>
                      <TableCell>
                        {row.clientRenewalNotificationTimestamp}
                      </TableCell>
                      <TableCell>
                        {row.clientRenewalNotificationTypem}
                      </TableCell>
                      <TableCell>{row.clientCISO}</TableCell>
                      <TableCell>{row.clientLogo}</TableCell>
                      <TableCell>{row.clientCorrespondenceAddress}</TableCell>
