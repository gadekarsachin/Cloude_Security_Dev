...
export default function ScanPolicy() {
  ...
  const handleToggleDescription = (index) => {
    ...
    // Close the corresponding title cell
  ...
  const handleToggleTitle = (index) => {
    ...
    // Close the corresponding description cell
    setExpandedDescription((prevState) => ({
      ...prevState,
      [index]: false,
    }));
  ...
  const handleToggleRecommendation = (index) => {
    setExpandedRecommendation((prevState) => ({
      ...prevState,
      [index]: !prevState[index],
    }));
  };
  ...
  const dataToSend =
    { id: "64f84b0607e7a348bcbfc0cb", menuname: "plugindata" } || {};
  const pathSubMenu = "/scanPolicy";
  ...
  function fetchData(token) {
    ...
    headers.append(
      "Authorization",
      `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2MzgxMDgyNTQyYTM4NWE4MWYyMDY1ZDEiLCJpYXQiOjE2OTc3MTU0NzEsImV4cCI6MTcwMDMxMTA3MSwidHlwZSI6InJlZnJlc2gifQ.gibq0cl-CvjRJBnLE4KGkKtmK_fti8f7mlkwcCt5nsc`
    );
    ...
    fetch(
      ...
      .then((result1) => {
        ...
        {
          console.log("getData", parsedResult1);
        }
      ...
      <div className="main-card mb-3 card">
        <div className="card-header">
          <div className="card-header-title font-size-lg text-none font-weight-normal">
            {" List of available scan policies "}
          </div>
        </div>
                  ...
                  >
                    {gethead.length > 0 ? (
                      <>
                        ...
                        <th className="text-center">Policy Description</th>
                      ...
                      >
                        ...
                        >
                          {expandedTitle[index] ? (
                            ...
                            <>
                              {row.PluginTitle.slice(0, 40)}{" "}
                              {row.PluginTitle.length > 40 && (
                                <button
                                  style={{
                                    backgroundColor: "transparent", // Remove background color
                                    border: "none", // Remove border
                        ...
                        >
                          {expandedDescription[index] ? (
                            ...
                            <>
                              {row.PluginDescription.slice(0, 40)}{" "}
                              {row.PluginDescription.length > 40 && (
                                <button
                                  style={{
                                    backgroundColor: "transparent", // Remove background color
                                    border: "none", // Remove border
                          ...
                          {expandedRecommendation[index] ? (
                            <>
                              ...
                              <button
                                ...
                                onClick={() =>
                                  handleToggleRecommendation(index)
                                }
                              >
                                Show Less
                              </button>
                            ...
                            <>
                              {row.Recommendation.slice(0, 40)}{" "}
                              {row.Recommendation.length > 40 && (
                                <button
                                  style={{
                                    backgroundColor: "transparent",
                                    border: "none",
