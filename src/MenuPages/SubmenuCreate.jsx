...
export default function SubmenuCreate() {
  ...
  //   setQuestions([...questions, { id: maxId + 1, question: "", answer: "" }]);
  // };
  ...
  //     if (q.id === questionId) {
  //       return { ...q, answer: event.target.value };
  //     }
  //     return q;
  //   });
  //   setQuestions(updatedQuestions);
  ...
  const { data, fieldsArray, dataToSend, pathSubMenu } = location.state || {};
