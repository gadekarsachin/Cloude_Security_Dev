...
export default function Assets() {
  ...
  const dataToSend =
    { id: "64f8524b07e7a348bcbfc0fe", menuname: "discoveryscandata" } || {};
  const pathSubMenu = "/assets";
            ...
            <table>
              <thead>
                ...
                >
                  {gethead.length > 0 ? (
                    <>
                      <th className="text-center">account_id</th>
                      <th className="text-center">account_principal</th>
                      <th className="text-center">run_timestamp</th>
                ...
                {getData && getData.length > 0 ? (
                  getData.map((row) => (
                    ...
                    >
                      ...
                      <TableCell>{row.account_principal}</TableCell>
                      <TableCell>{row.run_timestamp}</TableCell>
                      <abbr title="Report">
                        <TableCell>
                          <GrScan
                            style={{
