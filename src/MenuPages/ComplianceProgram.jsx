...
export default function ComplianceProgram() {
  ...
  const dataToSend =
    { id: "64f8493c07e7a348bcbfc0bc", menuname: "programdata" } || {};
  const pathSubMenu = "/complianceProgram";
                ...
                {getData && getData.length > 0 ? (
                  getData.map((row) => (
                    ...
                    >
                      ...
                      <TableCell>{row.programShortName}</TableCell>
                      <TableCell>{row.programName}</TableCell>
                      <TableCell>{row.programVersion}</TableCell>
                      <TableCell>{row.programDescription}</TableCell>
                      <TableCell>{row.programType}</TableCell>
                      <TableCell>{row.programOwner}</TableCell>
                      <TableCell>{row.programCreatedOn}</TableCell>
                      <TableCell>{row.programUpdatedOn}</TableCell>
                      <TableCell>{row.programStatus}</TableCell>
                      <TableCell>{row.programClients1}</TableCell>
                      <TableCell>{row.programClientOwner1}</TableCell>
                      <TableCell>{row.programClientCreatedBy1}</TableCell>
                      <TableCell>{row.programClientUpdatedBy1}</TableCell>
